...
CREATE TABLE "Fantasy"."Liga" (
    ...
    "es_publica"            boolean                         NOT NULL,
        ...
        CONSTRAINT "Liga FOREIGN KEY usuario REFERENCES Usuario"
            FOREIGN KEY ("usuario")
            REFERENCES "Fantasy"."Usuario" ("id")
            ON DELETE CASCADE
);
...
CREATE TABLE "Fantasy"."Invita" (
    ...
    "aceptado"              boolean                         NOT NULL,
        ...
        CONSTRAINT "Invita PRIMARY KEY"
            PRIMARY KEY ("id"),

        CONSTRAINT "Invita FOREIGN KEY liga REFERENCES Liga"
            FOREIGN KEY ("liga")
            REFERENCES "Fantasy"."Liga" ("id")
            ON DELETE CASCADE,

        CONSTRAINT "Invita FOREIGN KEY usuario REFERENCES Usuario"
            FOREIGN KEY ("usuario")
            REFERENCES "Fantasy"."Usuario" ("id")
            ON DELETE CASCADE

/*No se como Escribiria esto, email es un FOREIGN KEY pero 
no necesariamente tiene que salir en la tabla destino, 
esto para permitir invitaciones por correo a usuarios no registrados en 
el sistema*/
...
CREATE TABLE "Fantasy"."Participa" (
	...
	CONSTRAINT "Participa PRIMARY KEY"
        ...
        CONSTRAINT "Participa FOREIGN KEY roster REFERENCES Roster"
            FOREIGN KEY ("roster")
            REFERENCES "Fantasy"."Roster" ("id")
            ON DELETE CASCADE,
...
CREATE TABLE "Fantasy"."Calendario" (
    "id"                        serial                          NOT NULL,
    "fecha"                     timestamp with time zone        NOT NULL,
	...
	CONSTRAINT "Calendario PRIMARY KEY"
            PRIMARY KEY ("id"),

        CONSTRAINT "Calendario FOREIGN KEY local REFERENCES Equipo"
            FOREIGN KEY ("local")
            REFERENCES "Fantasy"."Equipo" ("id")
            ON DELETE CASCADE,

        CONSTRAINT "Calendario FOREIGN KEY visitante REFERENCES Equipo"
            FOREIGN KEY ("visitante")
            REFERENCES "Fantasy"."Equipo" ("id")
            ON DELETE CASCADE,

        CONSTRAINT "Calendario FOREIGN KEY local REFERENCES Estadio"
            FOREIGN KEY ("estadio")
            REFERENCES "Fantasy"."Estadio" ("id")
            ON DELETE CASCADE
...
CREATE TABLE "Fantasy"."Juego"(
    ...
    "hits_local"                integer                     NOT NULL default 0,
    "hits_visitante"            integer                     NOT NULL default 0,
    "carreras_local"            integer                     NOT NULL default 0,
    "carreras_visitante"        integer                     NOT NULL default 0,
    "errores_local"             integer                     NOT NULL default 0,
    "errores_visitante"         integer                     NOT NULL default 0,
    "terminado"                 boolean                     NOT NULL default false,

	CONSTRAINT "Juego PRIMARY KEY"
            PRIMARY KEY ("id"),

        CONSTRAINT "Juego FOREIGN KEY jornada REFERENCES Calendario"
            FOREIGN KEY ("jornada")
            REFERENCES "Fantasy"."Calendario" ("id")
            ON DELETE CASCADE
